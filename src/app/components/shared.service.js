...
var SharedService = (function () {
    ...
    SharedService.prototype.announceMission = function (mission) {
        this.missionAnnouncedSource.next(mission);
    };
    SharedService.prototype.confirmMission = function (astronaut) {
        this.missionConfirmedSource.next(astronaut);
    };
    SharedService.prototype.insertData = function (data) {
        this.dataArray.unshift(data);
    };
    SharedService.prototype.insertData2 = function (data) {
        alert('2  ');
        this.myString = data;
    };
